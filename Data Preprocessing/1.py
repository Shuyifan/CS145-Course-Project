...
ignore = ['address', 'attributes', 'attributes_Ambience', 'attributes_BestNights', 
        'attributes_BusinessParking', 'attributes_GoodForMeal','attributes_HairSpecializesIn',
         ...
         'attributes_RestaurantsPriceRange2', 'attributes_DietaryRestrictions', 'is_open']
preorder = ['attributes_AgesAllowed', 'attributes_Alcohol', 'attributes_NoiseLevel', 'attributes_WiFi']
d = {}
